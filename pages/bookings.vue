...
<template>
	<div>
		<div class="overflow-hidden font-domainemedium text-brand-grey-light">
			<section class="relative h-auto w-screen flex flex-col z-20 bg-brand-light-cream bg-opacity-60">
				...
				<div class="flex h-auto w-full sm:w-4/5 md:w-3/4 lg:w-2/3 mx-auto border-2 border-brand-rose-light bg-brand-rose-gold rounded-2xl">
					<p class="text-4xl md:text-5xl m-2 p-2 text-brand-light-cream">
				...
				<div class="grid grid-cols-1 sm:grid-cols-2 lg:gap-10 xl:gap-24 w-screen h-auto mb-5 m-5 mx-auto lg:px-5 xl:px-10">
					<article class="grid col-span-1 min-h-min m-1 border-2 border-brand-rose-light rounded-2xl shadow-2xl shadow-rose-50">
						<span class="h-40 bg-brand-rose-gold rounded-xl">
							<h1 class="font-domainebold text-4xl lg:text-5xl text-brand-light-cream m-1 p-1">Consultation & first session</h1>
						</span>
					...
					<article class="grid col-span-1 min-h-min m-1 border-2 border-brand-rose-light rounded-2xl shadow-2xl shadow-rose-50">
						<span class="h-40 bg-brand-rose-gold rounded-xl">
							<h1 class="text-4xl lg:text-5xl text-brand-light-cream m-1 p-1">Individual session</h1>
