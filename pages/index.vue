		...
		<div class="overflow-hidden font-domaineregular text-neutral-700">
			...
			<main class="relative h-auto w-screen z-20 bg-white bg-opacity-60">
				<section class="relative flex flex-col h-screen w-screen justify-end">
					<div class="text-brand-rose-gold text-6xl sm:text-7xl md:text-8xl xl:text-9xl m-2 p-2 mb-20">
						<h1>Justine</h1>
						<h1>Hodgson</h1>
						<h1>Integrated</h1>
						<h1>Therapies</h1>
				...
				<section class="relative flex flex-col h-screen w-screen justify-evenly">
					<blockquote class="m-1 p-1 xl:w-3/4 2xl:w-1/2">
						<p class="text-2xl sm:text-3xl lg:text-4xl m-1 p-1 md:m-2 md:p-2">
							...
							at this time in your life, no matter what it is, please be assured there is a reason and that there is help for you if you
							wish to receive it.
						</p>
					</blockquote>
				...
				<!-- Personal video -->
				<div class="flex-flex-col w-screen sm:w-1/2 h-auto m-1 p-1 place-items-end">
					<p class="text-lg sm:text-xl md:text-2xl lg:text-3xl m-1 p-1">
						Please click the button below to watch a short video about me and my journey so far.
					</p>

					<button class="border-2 border-brand-rose-gold rounded-2xl text-xl m-2 p-2">Watch video</button>
				</div>
				<div class="relative h-auto w-screen flex flex-row z-30 place-content-end items-center">
					<span class="m-1 p-1">
