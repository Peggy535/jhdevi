...
<template>
	<div>
		<div class="flex flex-col h-screen w-screen text-brand-champagne-gold font-domainemedium place-content-end">
		...
		<div class="flex flex-col w-screen h-auto font-domainemedium p-2">
			<div class="flex w-full">
				<div v-for="audio in audios" :key="audio._id">
					<article class="relative border border-brand-champagne-light rounded-2xl w-full sm:w-2/3 m-2 mx-auto">
						<div class="h-32 bg-brand-champagne-gold rounded-xl text-brand-grey-light p-2">
						...
						<div class="relative m-1 p-1 text-brand-grey-light">
							...
							<button
								class="snipcart-add-item absolute bottom-0 right-0 border border-brand-champagne-gold rounded-3xl text-lg p-2"
