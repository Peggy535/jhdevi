...
<template>
	<div>
		...
		<div class="relative flex h-auto w-screen font-domainemedium text-brand-champagne-gold z-20">
			<h1 class="text-6xl sm:text-7xl md:text-7xl xl:text-9xl m-1 p-1 my-20">JH Blog</h1>
		</div>
		<div
			class="relative grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-10 lg:gap-14 xl:gap-16 w-screen h-auto mb-5 font-domainesemibold lg:font-domainemedium px-2 md:px-4 z-20 text-brand-grey bg-white"
		>
