...
<template>
	<div>
		...
		<div
			class="relative grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-10 lg:gap-20 xl:gap-16 w-screen h-auto mb-5 font-domainemedium px-2 md:px-4 lg:px-8 z-20 text-brand-grey-light bg-white"
		>
