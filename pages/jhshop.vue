<template>
	<div>
		<div class="flex flex-col h-screen w-screen text-brand-rose-gold font-domaineregular place-content-end">
			...
			<h3 class="text-3xl m-1 p-1">Discover the 12 Steps to you program, individual therapy audios and more.</h3>
		</div>
		<div class="flex flex-col w-screen h-auto font-domaineregular">
			<div class="flex w-full">
				<article class="relative border border-brand-rose-gold rounded-2xl w-full sm:w-2/3 m-2 mx-auto">
					<div class="h-32 bg-brand-rose-gold rounded-xl text-white p-2">
						...
						<h1 class="text-2xl">Individual audio's & videos to taregt specific issues</h1>
					</div>
					<div class="relative m-1 p-1 text-brand-rose-gold">
						<p class="h-48 text-lg">A great solution to help you target a specific aspect or issue.</p>
			...
			<div class="flex w-full">
				<article class="relative border border-brand-rose-gold rounded-2xl w-full sm:w-2/3 m-2 mx-auto">
					...
					<div class="relative m-1 p-1 text-brand-rose-gold">
						<p class="h-48 text-lg">A description about the 12 steps here, brielfy what it is etc....</p>
